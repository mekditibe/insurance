...
export class AddCarComponent{
  ...
  carForm!: FormGroup;
  cars!:ICar;
  constructor(private formBuilder:FormBuilder, private cartService:CarService, private router:Router, private errorService:CheckErrorService) {
  ...
  public checkError = (controlName: string, errorName: string) => {
    // return this.errorService(controlName,errorName,this.carForm);
